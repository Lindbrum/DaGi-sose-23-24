...
public class RESTServiceApplication {
	...
	public OpenAPI customOpenAPI(@Value("${springdoc.version}") String appVersion) {
		 return new OpenAPI()
			        ...
			        //info
			        .info(new Info()
				        .title("Merchandise microservice API")
				        .version(appVersion)
				        .description("This RESTful service provide an interface for creation, modification and removal of merchandise articles to be published and sold in events.")
