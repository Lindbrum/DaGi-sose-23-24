...
public class HttpHeaders extends HashMap<String, List>  {
  ...
  @Schema(description = "")
  private List<HttpHeadersAcceptLanguageAsLocales> acceptLanguageAsLocales = null;
  ...
  @Schema(description = "")
  private HttpHeadersAcceptLanguageAsLocales contentLanguage = null;
  ...
  **/
  ...
  public List<HttpHeadersAcceptLanguageAsLocales> getAcceptLanguageAsLocales() {
    return acceptLanguageAsLocales;
  }

  public void setAcceptLanguageAsLocales(List<HttpHeadersAcceptLanguageAsLocales> acceptLanguageAsLocales) {
    this.acceptLanguageAsLocales = acceptLanguageAsLocales;
  }

  public HttpHeaders acceptLanguageAsLocales(List<HttpHeadersAcceptLanguageAsLocales> acceptLanguageAsLocales) {
    this.acceptLanguageAsLocales = acceptLanguageAsLocales;
    return this;
  }

  public HttpHeaders addAcceptLanguageAsLocalesItem(HttpHeadersAcceptLanguageAsLocales acceptLanguageAsLocalesItem) {
  ...
  **/
  ...
  public HttpHeadersAcceptLanguageAsLocales getContentLanguage() {
    return contentLanguage;
  }

  public void setContentLanguage(HttpHeadersAcceptLanguageAsLocales contentLanguage) {
    this.contentLanguage = contentLanguage;
  }

  public HttpHeaders contentLanguage(HttpHeadersAcceptLanguageAsLocales contentLanguage) {
    this.contentLanguage = contentLanguage;
    return this;
  }
