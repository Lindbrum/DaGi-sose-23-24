...
public class RESTServiceApplication {
	...
	public OpenAPI customOpenAPI(@Value("${springdoc.version}") String appVersion) {
		 return new OpenAPI()
			        ...
			        //info
			        .info(new Info()
				        .title("Event Info Prosumer")
				        .version(appVersion)
				        .description("This is a RESTful API that collects and returns information on events and the merchandise that can be found at an event.")
